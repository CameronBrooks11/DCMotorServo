#ifndef DCMotorTacho_Legacy_h
#define DCMotorTacho_Legacy_h

#include "DCMotorServo.h"

/**
 * @class DCMotorTacho_Legacy
 ...
 */
class DCMotorTacho_Legacy : public DCMotorServo
{
public:
    /**
     * Constructor for DCMotorTacho_Legacy.
     ...
     */
    DCMotorTacho_Legacy(MotorWriteFunc mWrite, MotorBrakeFunc mBrake, EncoderReadFunc eRead, EncoderWriteFunc eWrite,
