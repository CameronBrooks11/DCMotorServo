...
0. Carry over from servo_config: position PID gains (step 03) and the empirical fudge factor / CPR (step 04). Set `PPR`, `GEAR_RATIO`, and `EMPIRICAL_FUDGE_FACTOR` in the sketch defines — an uncalibrated CPR makes every RPM reading proportionally wrong.
